...
El debate sigue siendo relevante hoy:
- **Linux** domina servidores, móviles (Android), supercomputadores, IoT
- **MINIX** se usa en Intel ME (Intel Management Engine) como sistema embebido
- **GNU Hurd** sigue en desarrollo activo pero sin uso práctico
- Los micronúcleos modernos (seL4, Zircon de Google) son usados en sistemas embebidos y críticos
- El debate se repite con Rust en el kernel: ¿debería el kernel ser más seguro a costa de rendimiento?
