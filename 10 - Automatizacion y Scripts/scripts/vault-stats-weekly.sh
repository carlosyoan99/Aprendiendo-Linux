...
# Ubicación: 10 - Automatizacion y Scripts/scripts/vault-stats-weekly.sh
...
SCRIPT="$VAULT_DIR/10 - Automatizacion y Scripts/scripts/vault-stats.sh"
LOG="$VAULT_DIR/10 - Automatizacion y Scripts/vault-stats-weekly.log"
