...
Xero Linux es una distribución Arch Linux que ofrece una experiencia **KDE Plasma 5** lista para usar, con personalizaciones visuales extensas (temas GRUB, Konsole alias, neofetch custom) y soporte para GPU NVIDIA heredado.
...
- **Konsole alias**: ejecuta `alias` para ver la lista
...
- Soporte NVIDIA heredado incluido
- Partición XFS por defecto

## Enlaces externos

- [Sitio oficial](https://xerolinux.xyz/)
- [Wikipedia — Xero Linux](https://es.wikipedia.org/wiki/Xero_Linux)
